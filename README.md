...
| saasfly                    | An easy-to-use and enterprise-grade Next.js boilerplate monorepo with bun package manager with poweful typesafe features: TRPC, i18n, SEO.  A magic trip start with `bun create saasfly`.                                                                                                | [Link](https://github.com/saasfly/saasfly)                  |

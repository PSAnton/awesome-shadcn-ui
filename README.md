...
| saasfly                    | An easy-to-use and enterprise-grade Next.js boilerplate monorepo with bun package manager with poweful typesafe features: TRPC, i18n - Support for internationalization, SEO - Search engine optimization, Turbo MonoRepo for better code management. T3 Env - Manage your environment variables with ease. A magic trip start with `bun create saasfly` .                                                                                                    | [Link](https://github.com/saasfly/saasfly)                  |
